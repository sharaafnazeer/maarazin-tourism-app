    ...
    <div className="row x-gap-20 y-gap-20">
      <div className="col-12">
        <div className="form-input ">
          <input
            type="text"
            required
            defaultValue={(selectedHotel && hotelId) ? selectedHotel.name : ''}
            id="name"
      ...
      <div className="col-12">
        <div className="form-input ">
          <textarea
            required
            defaultValue={(selectedHotel && hotelId) ? selectedHotel.description:''}
            rows={5}
            // defaultValue={""}
            id="content"
      ...
      <div className="mt-10">
        <div className="row">
          ...
          <div className="col-md-6">
            <div className="col-12">
              <select className="form-select rounded-10 border-light-1 justify-between text-12 fw-500 px-20 w-200 h-50  sm:w-full text-14"
                id="hotelGroupId"
                value={(selectedHotel && hotelId) ? selectedHotel.hotelGroup:''}
                onChange={(event) => onChange(event.target.id, event.target.value)}
              >
