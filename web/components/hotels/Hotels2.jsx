...
const Hotels2 = ({similarHotels}) => {
    var settings = {
        dots: true, infinite: true, speed: 500, slidesToShow: 4, slidesToScroll: 1, responsive: [{
                    ...
                    >
                        <div className="hotelsCard__image">
                            <div className="cardImage inside-slider">
                                ...
                                {/*    <div*/}
                                {/*        className={`py-5 px-15 rounded-right-4 text-12 lh-16 fw-500 uppercase ${isTextMatched(item?.tag, "breakfast included") ? "bg-dark-1 text-white" : ""} ${isTextMatched(item?.tag, "best seller") ? "bg-blue-1 text-white" : ""}  ${isTextMatched(item?.tag, "top rated") ? "bg-yellow-1 text-dark-1" : ""}`}*/}
                                {/*    >*/}
                                {/*        {item?.tag}*/}
                                {/*    </div>*/}
                                {/*</div>*/}
                        ...
                        <div className="hotelsCard__content mt-10">
                            ...
                            <div className="d-flex items-center mt-20">
                                ...
                                <div className="text-14 text-dark-1 fw-500 ml-10">
                                    {item?.rating >= 4 ? 'Exceptional' : 'Normal'}
                                </div>
                            ...
                            <div className="mt-5">
                                <div className="fw-500">
                                    Starting from{" "}
                                    <span className="text-blue-1">US ${item?.minimumPrice}</span>
                                </div>
                            </div>
                        </div>
                    </Link>
