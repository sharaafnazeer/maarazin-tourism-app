    ...
    <div className="px-30 py-30 border-light rounded-4">
      ...
      <div className="row x-gap-15 y-gap-20">
        <div className="col-auto">
          <img
            ...
            height={140}
            src={
              reservationData?.reservationDetails?.reservationHotelDetails
                ?.featuredImages[0]
            }
            alt="image"
        ...
        <div className="col">
          ...
          <div className="lh-17 fw-500">
            ...
            {reservationData?.reservationDetails?.reservationHotelDetails
              ?.location?.city &&
              `${reservationData?.reservationDetails?.reservationHotelDetails?.location?.city}`}
          </div>
            ...
            {reservationData?.reservationDetails?.reservationHotelDetails
              ...
              <>
                {reservationData?.reservationDetails?.reservationHotelDetails
                  ...
                  `${reservationData?.reservationDetails?.reservationHotelDetails?.location?.city}`}
                {reservationData?.reservationDetails?.reservationHotelDetails
                  ?.reservationDetails?.location?.state &&
                  `, ${reservationData?.reservationDetails?.reservationHotelDetails?.location?.state}`}
                {reservationData?.reservationDetails?.reservationHotelDetails
                  ?.location?.country &&
                  `, ${reservationData?.reservationDetails?.reservationHotelDetails?.location?.country}`}
              </>
            )}
          </div>
        </div>
      ...
      <div className="row y-gap-20 justify-between">
        <div className="col-auto">
          ...
          <div className="fw-500">
            {reservationData?.reservationDetails?.reservationQueryDetails?.from
              ? moment(
                  reservationData?.reservationDetails?.reservationQueryDetails
                    ?.from
        ...
        <div className="col-auto text-right md:text-left">
          ...
          <div className="fw-500">
            {reservationData?.reservationDetails?.reservationQueryDetails?.to
              ? moment(
                  reservationData?.reservationDetails?.reservationQueryDetails
                    ?.to
                ).format("ddd, MMM Do YYYY")
      ...
      <div className="row y-gap-20 justify-between items-center">
        <div className="col-auto">
          ...
          <div className="fw-500">
            {reservationData?.reservationDetails?.reservationRoomDetails?.room
              ?.name || ""}
          </div>
          <a
            href={`/hotel/hotel-single-view/${
              reservationData?.reservationDetails?.reservationHotelDetails?._id
            }?${queryParamsBuilderOnObject(
              reservationData?.reservationDetails?.reservationQueryDetails
            )}`}
        ...
        <div className="col-auto">
          <div className="text-15">
            {reservationData?.reservationDetails?.reservationRoomDetails
              ?.finalPrice || 0}
            {", "}
            {`${Number(
              reservationData?.reservationDetails?.reservationQueryDetails
