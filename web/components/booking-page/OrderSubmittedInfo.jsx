                ...
                <div className="order-completed-wrapper">
                    <div className="d-flex flex-column items-center mt-40 lg:md-40 sm:mt-24">
                        ...
                        <div className="text-15 text-light-1 mt-10">
                            Booking details has been sent to: {' '}{reservationData?.reservationConfirmationDetails?.customer?.email || ''}
                        </div>
                    </div>
                    {/* End header */}
                        ...
                        <div className="row">
                            <div className="col-lg-3 col-md-6">
                                ...
                                <div className="text-15 lh-12 fw-500 text-blue-1 mt-10">
                                    {reservationData?.reservationConfirmationDetails?.refNumber || ''}
                                </div>
                            </div>
                            {/* End .col */}
                            <div className="col-lg-3 col-md-6">
                                ...
                                <div className="text-15 lh-12 fw-500 text-blue-1 mt-10">
                                    {reservationData?.reservationConfirmationDetails?.reservationDateTime || ''}
                                </div>
                            </div>
                            {/* End .col */}
                            <div className="col-lg-3 col-md-6">
                                ...
                                <div className="text-15 lh-12 fw-500 text-blue-1 mt-10">
                                    $ {reservationData?.reservationConfirmationDetails?.totalAmount || ''}
                                </div>
                            </div>
                            {/* End .col */}
                            {/*<div className="col-lg-3 col-md-6">*/}
                        ...
                        <div className="row y-gap-10">
                            <div className="col-12">
                                <div className="d-flex justify-between ">
                                    ...
                                    <div className="text-15 lh-16 fw-500 text-blue-1">
                                        {reservationData?.reservationConfirmationDetails?.customer?.fullName || ''}
                                    </div>
                                </div>
                            </div>
                            {/* End .col */}
                            ...
                            <div className="col-12">
                                <div className="d-flex justify-between border-top-light pt-10">
                                    ...
                                    <div className="text-15 lh-16 fw-500 text-blue-1">
                                        {reservationData?.reservationConfirmationDetails?.customer?.email || ''}
                                    </div>
                                </div>
                            </div>
                            {/* End .col */}
                            <div className="col-12">
                                <div className="d-flex justify-between border-top-light pt-10">
                                    ...
                                    <div className="text-15 lh-16 fw-500 text-blue-1">
                                        {reservationData?.reservationConfirmationDetails?.customer?.phoneNumber || ''}
                                    </div>
                                </div>
                            </div>
                            {/* End .col */}
                            <div className="col-12">
                                <div className="d-flex justify-between border-top-light pt-10">
                                    ...
                                    <div className="text-15 lh-16 fw-500 text-blue-1">
                                        {reservationData?.reservationConfirmationDetails?.customer?.addressLine1 || ''}
                                    </div>
                                </div>
                            </div>
                            {/* End .col */}
                            <div className="col-12">
                                <div className="d-flex justify-between border-top-light pt-10">
                                    ...
                                    <div className="text-15 lh-16 fw-500 text-blue-1">
                                        {reservationData?.reservationConfirmationDetails?.customer?.addressLine2 || ''}
                                    </div>
                                </div>
                            </div>
                            {/* End .col */}
                            <div className="col-12">
                                <div className="d-flex justify-between border-top-light pt-10">
                                    ...
                                    <div className="text-15 lh-16 fw-500 text-blue-1">
                                        {reservationData?.reservationConfirmationDetails?.customer?.state || ''}
                                    </div>
                                </div>
                            </div>
                            {/* End .col */}
                            ...
                            <div className="col-12">
                                <div className="d-flex justify-between border-top-light pt-10">
                                    ...
                                    <div className="text-15 lh-16 fw-500 text-blue-1">
                                        {reservationData?.reservationConfirmationDetails?.customer?.zipCode || ''}
                                    </div>
                                </div>
                            </div>
                            {/* End .col */}
                            ...
                            <div className="col-12">
                                <div className="d-flex justify-between border-top-light pt-10">
                                    ...
                                    <div className="text-15 lh-16 fw-500 text-blue-1">
                                        {reservationData?.reservationConfirmationDetails?.customer?.specialRequests || ''}
                                    </div>
                                </div>
                            </div>
                            {/* End .col */}
